...
NewCharWindow::NewCharWindow()
{
    ...
    addWidget(scrollAreaSkill);
}

void NewCharWindow::initiateRaces()
{
...
void NewCharWindow::initiateClasses()
{
...
void NewCharWindow::initiateAlignment()
{
...
void NewCharWindow::initiateAbilities()
{
    // QGroupBox necessary with radio buttons
...
void NewCharWindow::initiateFeats()
{
...
void NewCharWindow::initiateHitDie()
{
    // Nothing fancy here
...
void NewCharWindow::initiateGold()
{
    // Nothing fancy here
...
void NewCharWindow::initiateSkill()
{
    // Labels
...
void NewCharWindow::setRaceValues(int STR, int DEX, int CON, int INT, int WIS, int CHA)
{
...
void NewCharWindow::updateRaceChoice()
{
    updateAbilities();
    updateClassChoice(); // To change the feats in case of Human.
}

void NewCharWindow::updateAbilities()
{
...
void NewCharWindow::updateClassChoice()
{
...
void NewCharWindow::updateAlignment()
{
...
void NewCharWindow::updateAlignment(ifstream &file)
{
    file >> enLint;
    file >> enN1;
    file >> enC;
...
void NewCharWindow::updateHitDie(ifstream &file)
{
    string diceText;
    int diceValue;
...
void NewCharWindow::updateGold(ifstream &file)
{
    string goldText;
    int maxValue;
    int meanValue;
...
void NewCharWindow::updateFeats(ifstream &file)
{
    file >> numberFeats;
...
void NewCharWindow::updateSkill(ifstream &file)
{
    resetClassSkill();
    resetRanks();
...
void NewCharWindow::resetClassSkill()
{
    for (int j = 0; j <= 34; j++)
    {
...
void NewCharWindow::updateRanksLeft()
{
    int sum(0);
    int temp;
    for (int j = 0; j <= 34; j++)
